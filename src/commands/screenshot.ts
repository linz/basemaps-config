...
const TileTest = [
  ...
  { name: 'health-2193-z5', tileMatrix: Nztm2000QuadTms, location: { lat: -41.8899962, lng: 174.0492437, z: 1 }, tileSet: 'aerial' },
  ...
  { name: 'topolite-3857-z17', tileMatrix: GoogleTms, location: { lat: -43.8063936, lng: 172.9679876, z: 17 }, tileSet: 'topographic', style: 'topolite' },
];
